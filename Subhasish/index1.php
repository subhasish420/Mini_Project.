    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="" data-bs-toggle="modal" data-bs-target="#employeemodel">Employee Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="" data-bs-toggle="modal" data-bs-target="#exampleModal">Admin Login</a>
          </li>
      ...
      <div class="row justify-content-start mx-3">
        <div class="col ">
         <div class="badge text-wrap py-3 px-3 fs-6 mat" id="primary">
          ...
          <div class="fs-1 fw-bold  mat mC">CO_WIN</div>
