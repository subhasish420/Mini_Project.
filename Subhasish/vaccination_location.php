...
<nav class="navbar navbar-expand-lg navbar-dark mB">
  <div class="container-fluid">
    <img class="img-fluid " src="assets/bagchi2.png" width="80px">
...
<button type="submit" name="delete" class="btn text-white fs-10 del hBtn" value="">Remove</button>
...
<form name="form1"  method="post">
<button type="submit" name="delete_loc" class="btn text-white fs-10 del hBtn" value="">Remove</button>
